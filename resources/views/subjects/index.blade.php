                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <form id="deleteSubjectForm{{ $subject->id }}" action="{{ route('subjects.destroy', $subject->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            <script>
                                                function confirmDeleteSubject(subjectId) {
                                                    Swal.fire({
                                                        title: "Are you sure?",
                                                        text: "This action cannot be undone. The subject and its related data will be deleted!",
                                                        icon: "warning",
