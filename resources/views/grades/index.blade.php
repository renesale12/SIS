                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <form id="deleteGradeForm{{ $grade->id }}" action="{{ route('grades.destroy', $grade->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" class="btn btn-link text-danger text-gradient px-3 mb-0" onclick="confirmDelete({{ $grade->id }})">
                                            ...
                                            function confirmDelete(gradeId) {
                                                Swal.fire({
                                                    ...
                                                    if (result.isConfirmed) {
                                                        document.getElementById("deleteGradeForm" + gradeId).submit();
                                                    }
                                                });
                                            }
                                        </script>
